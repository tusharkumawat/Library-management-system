...
public class SearchBooks2 extends JPanel
{
	...
	public SearchBooks2() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				{
					int flag=0;
					String idd=JOptionPane.showInputDialog(SearchBooks2.this, "Enter ID", "Search", JOptionPane.PLAIN_MESSAGE);
					try
					{
					if(idd.equals(""))
					{
					...
					j.setLocationRelativeTo(SearchBooks2.this);
					j.setSize(600,600);
				...
				else if(comboBox.getSelectedItem()=="TITLE")
				{
					...
					int flag=0;
					String title=JOptionPane.showInputDialog(SearchBooks2.this, "Enter title(Case sensitive)", "Search", JOptionPane.PLAIN_MESSAGE);
					try
					{
					if(title.equals(""))
					{
				...
				else if(comboBox.getSelectedItem()=="AUTHOR")
				{
					...
					String author=JOptionPane.showInputDialog(SearchBooks2.this, "Enter author", "Search", JOptionPane.PLAIN_MESSAGE);
					try
					{
					if(author.equals(""))
					{
				...
				{	int flag=0;
					String pub=JOptionPane.showInputDialog(SearchBooks2.this, "Enter publisher", "Search", JOptionPane.PLAIN_MESSAGE);
					try
					{
					if(pub.equals(""))
					{
				...
				{
					int flag=0;
					String sub=JOptionPane.showInputDialog(SearchBooks2.this, "Enter subject", "Search", JOptionPane.PLAIN_MESSAGE);
					try
					{
					if(sub.equals(""))
					{
				...
				{
					int flag=0;
					String cat=JOptionPane.showInputDialog(SearchBooks2.this, "Enter category", "Search", JOptionPane.PLAIN_MESSAGE);
					try
					{
					if(cat.equals(""))
					{
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				StudentPageTabbedpane.remove("Search book");
			}
		});
	...
	{
		loginpage.st=new StudentPage();
		loginpage.st.setVisible(true);
	}
