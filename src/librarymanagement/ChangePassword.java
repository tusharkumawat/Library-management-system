...
public class ChangePassword extends JPanel {
	...
	private JPasswordField passwordField_2;
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try
				{
					...
					ps.setString(1, loginpage.adminid);
					...
					if(flag==1)
					{
						...
						ps.setString(2, loginpage.adminid);
						ps.setString(1,confpaass );
						ps.executeUpdate();
						JOptionPane.showMessageDialog(new ChangePassword(), "Password changed", "Success!!", JOptionPane.INFORMATION_MESSAGE);
					...
					else
					{
						...
						JOptionPane.showMessageDialog(new ChangePassword(), "Wrong password", "Error!!", JOptionPane.ERROR_MESSAGE);
				...
				{
					JOptionPane.showMessageDialog(new ChangePassword(), "Password not confirmed", "Error!!", JOptionPane.ERROR_MESSAGE);
				}
			}
		});
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AdminPageTabbedpane.remove("Change password");
			}
		});
